...
public class PieceManager : MonoBehaviour
{
    ...
    public void CreateYourPiece()
    {
        ...
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[3, 0], Enums.PieceSetting.Sha1);
        ...
        obj = GameObject.Instantiate<GameObject>(sha_p2);
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[5, 0], Enums.PieceSetting.Sha2);
        ...
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[0, 0], Enums.PieceSetting.Cha1);
        ...
        obj = GameObject.Instantiate<GameObject>(cha_p2);
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[8, 0], Enums.PieceSetting.Cha2);
        ...
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[1, 2], Enums.PieceSetting.Pho1);
        ...
        obj = GameObject.Instantiate<GameObject>(pho_p2);
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[7, 2], Enums.PieceSetting.Pho2);
        ...
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[2, 0], Enums.PieceSetting.Mha1);
        ...
        obj = GameObject.Instantiate<GameObject>(mha_p2);
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[6, 0], Enums.PieceSetting.Mha2);
        ...
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[1, 0], Enums.PieceSetting.Shang1);
        ...
        obj = GameObject.Instantiate<GameObject>(shang_p2);
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[7, 0], Enums.PieceSetting.Shang2);
        ...
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[0, 3], Enums.PieceSetting.Jol1);
        ...
        obj = GameObject.Instantiate<GameObject>(jol_p2);
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[2, 3], Enums.PieceSetting.Jol2);
        ...
        obj = GameObject.Instantiate<GameObject>(jol_p2);
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[6, 3], Enums.PieceSetting.Jol4);
        ...
        obj = GameObject.Instantiate<GameObject>(jol_p2);
        obj.transform.parent = pieceParent;
        obj.GetComponent<Piece>().Init(PointCreater.pointCompList[8, 3], Enums.PieceSetting.Jol5);
