...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class TapToPlaceParent : MonoBehaviour, IInputClickHandler
    {
        ...
        protected virtual void Update()
        {
            ...
            Vector3 fixedYPos = new Vector3(cameraTransform.position.x, OriginPos.y, cameraTransform.position.z);
            
            Vector3 placementPosition = GetPlacementPosition(fixedYPos, cameraTransform.forward, DefaultGazeDistance);
